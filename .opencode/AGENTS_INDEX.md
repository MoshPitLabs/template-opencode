...
|-------|-------|----------|
| **nextjs-fullstack** | Opus 4.5 | Next.js 16+ App Router full-stack applications |
| **react-typescript** | Opus 4.5 | React + TypeScript frontend development |
| **sveltekit-frontend** | Opus 4.5 | Svelte 5 + SvelteKit frontend-only |
| **sveltekit-fullstack** | Opus 4.5 | Svelte 5 full-stack with PostgreSQL + Tailwind |

### Backend Stack (5 agents)

| Agent | Model | Use Case |
|-------|-------|----------|
| **golang-backend-api** | Opus 4.5 | Go 1.25+ backend APIs and services |
...
| Agent | Model | Use Case |
|-------|-------|----------|
| **devops-infrastructure** | Opus 4.5 | Kubernetes, Docker, Terraform, ArgoCD, CI/CD |
...
| **mcp-server** | Opus 4.5 | MCP server integration |
...
| **rpg-mmo-systems-designer** | Opus 4.5 | RPG/MMO game systems design |
...
| **mlops-engineer** | Opus 4.5 | ML infrastructure and operations |
...
|---------|---------|---------------|
| **/ultrathink** | Deep analysis and problem solving | `[problem or question]` |
| **/diagnosis** | Systematic issue diagnosis | `[framework]` or flags |
| **/reflection** | Expert guide for reflection | Various |
| **/contemplation** | Contemplation/problem-solving | Various |
| **/refactor-code** | Code refactoring assistance | `[code location]` |
...
### Specialized Domains
- **Discord Bots**: `discord-golang-haiku45`
